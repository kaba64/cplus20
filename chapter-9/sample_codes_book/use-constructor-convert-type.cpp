...
auto main() -> int
{
  ...
  PrintHi(me);
  //PrintHi(3);
  /* Since the only input to the constructor is integer,
  the compiler will do the implicit conversion. However, 
  compiler will generate compilation error due to the presence of explicit ketword */
}
